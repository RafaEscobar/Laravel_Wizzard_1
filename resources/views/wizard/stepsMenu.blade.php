        ...
        <div class="flex">
            <div class="w-1/4">
                <div class="">
                    <div class="w-10 h-10 mx-auto bg-gray-500 rounded-full text-lg text-white flex items-center ">
                        <span class="text-center text-white w-full animate-pulse">
                ...
                <div class="text-xs text-center md:text-base">Inicio</div>
            </div>
            <div class="w-1/4">
                ...
                <div class="text-xs text-center md:text-base">Proceso</div>
            </div>
            ...
            <div class="w-1/4">
                <div class="relative mb-2">
                    ...
                    <div
                        class="w-10 h-10 mx-auto bg-gray-500 border-2 border-gray-200 rounded-full text-lg text-white flex items-center ">
                        <span class="text-center text-white w-full animate-pulse">
                            <svg class="w-full fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                width="24" height="24">
                                <path class="heroicon-ui"
                ...
                <div class="text-xs text-center md:text-base">Obtención</div>
            </div>
            <div class="w-1/4">
                <div class="relative mb-2">
                    <div class="absolute flex align-center items-center align-middle content-center"
                ...
                <div class="text-xs text-center md:text-base">Final</div>
            </div>
        </div>
    </div>
</div>